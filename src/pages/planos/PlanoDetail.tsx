          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-6">
              <div>
                ...
                <div className="text-sm text-gray-500">Valor fixo do plano</div>
              </div>
              {plano.servicos && plano.servicos.length > 0 && (
                <div>
                  <div className="text-2xl font-bold text-gray-900">{plano.servicos.length}</div>
        ...
        <div className="p-6">
          ...
          {servicosNaoVinculados.length > 0 && (
            <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <label htmlFor="servico-select" className="block text-sm font-medium text-gray-700 mb-2">
