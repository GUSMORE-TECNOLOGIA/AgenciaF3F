    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-md p-8 bg-card rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {error && (
            <div className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800/50 text-red-700 px-4 py-3 rounded">
              {error}
            </div>
          )}
              ...
              {!forgotSent ? (
                ...
                <>
                  <p className="text-sm text-green-700 font-medium">
                    Se o e-mail estiver cadastrado, você receberé um link para redefinir sua senha. Verifique sua caixa de entrada e o spam.
                  </p>
                  <button
                    type="button"
