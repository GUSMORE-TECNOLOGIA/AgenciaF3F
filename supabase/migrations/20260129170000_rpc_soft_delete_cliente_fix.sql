-- Ajustar soft_delete_cliente: permissão explícita para responsavel_id NULL e re-GRANT.
-- Clientes sem responsável (responsavel_id NULL) só podem ser deletados por admin.
...
COMMENT ON FUNCTION soft_delete_cliente(UUID) IS 'Soft delete de cliente e relacionados. Admin ou responsável do cliente. Clientes sem responsável apenas admin.';
