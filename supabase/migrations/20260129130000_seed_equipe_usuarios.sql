-- Seed equipe: auth.users + public.usuarios
-- Senha inicial: F3f@123trocar
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- rdlecal342@gmail.com -> Rafinha
INSERT INTO auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at)
VALUES ('00000000-0000-0000-0000-000000000000', 'ff2247ac-73c3-445e-ac7f-137477cb0012', 'authenticated', 'authenticated', 'rdlecal342@gmail.com', crypt('F3f@123trocar', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
INSERT INTO auth.identities (id, user_id, identity_data, provider, provider_id, last_sign_in_at, created_at, updated_at)
VALUES ('ff2247ac-73c3-445e-ac7f-137477cb0012', 'ff2247ac-73c3-445e-ac7f-137477cb0012', '{"sub":"ff2247ac-73c3-445e-ac7f-137477cb0012","email":"rdlecal342@gmail.com"}'::jsonb, 'email', 'ff2247ac-73c3-445e-ac7f-137477cb0012', NOW(), NOW(), NOW())
ON CONFLICT (provider, provider_id) DO NOTHING;
INSERT INTO public.usuarios (id, email, name, role, perfil, must_reset_password)
VALUES ('ff2247ac-73c3-445e-ac7f-137477cb0012', 'rdlecal342@gmail.com', 'Rafinha', 'admin', 'admin', true)
